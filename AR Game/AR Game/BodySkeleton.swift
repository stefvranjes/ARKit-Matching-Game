...
class BodySkeleton: Entity {
    ...
    required init(for bodyAnchor: ARBodyAnchor) {
        ...
        for jointName in ARSkeletonDefinition.defaultBody3D.jointNames {
            ...
            //NOTE: green joints are what ARKit can track, yellow joints are what ARKit can't track. also colours and sizes are based on the specific joint name
            switch jointName {
            ...
            //making an entity for the joint, add to joint directory, and it to the parent as well (bodySkeleton)
    ...
    func update(with bodyAnchor: ARBodyAnchor) {
        ...
        for bone in Bones.allCases {
            ...
            entity.look(at: skeletonBone.toJoint.position, from: skeletonBone.centerPosition, relativeTo: nil) //sets orientation for bones
        }
    }
